...
export function Footer() {
    return (
        <footer className="relative border-t border-border">
            <div className="container relative mx-auto max-w-6xl overflow-hidden border-x border-border px-5 pt-12 md:px-12 md:pt-16">
                <PlusMark className="left-0 top-0" />
                <PlusMark className="right-0 top-0 translate-x-1/2" />

                <div className="flex flex-col justify-between gap-10 pb-12 md:flex-row md:pb-16">
                ...
                <div aria-hidden className="select-none border-t border-border pt-6">
                    <p className="font-heading bg-gradient-to-b from-foreground/15 to-transparent bg-clip-text text-center text-[20vw] font-semibold leading-[0.8] tracking-tight text-transparent md:text-[17vw] lg:text-[13rem]">
                        SELTRAX
                    </p>
                </div>
            </div>
