...
export function Hero() {
    return (
        <section className="relative overflow-hidden pb-16 pt-36 md:pb-24 bg-gradient-to-b from-primary/10 to-background/10">
            ...
            <div className="container px-56 md:px-56 mx-auto relative z-10 flex flex-col items-center text-center">
                <motion.div
                ...
                <motion.h1
                    ...
                    className="font-chillax text-2xl md:text-4xl lg:text-[52px] font-semibold tracking-[0.02em] leading-[1.4] bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/70 mb-6 max-w-5xl"
                >
                ...
                <motion.p
                    ...
                    className="text-lg md:text-lg text-muted-foreground max-w-2xl mb-10 font-sans"
                >
